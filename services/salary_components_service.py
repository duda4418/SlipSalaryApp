...
def create_salary_component(db: Session, data: dict):
    return repo_create_salary_component(db, **data)

def update_salary_component(db: Session, component_id: str, data: dict):
    return repo_update_salary_component(db, component_id, **data)
